...
// TODO: Decide how modules are exposed (index.js vs direct).
// TODO: Create a single top-level router next to app.js?
const {router: userRouter} = require('./user');
const {router: profileRouter} = require('./profile');
const {router: articleRouter} = require('./article');
const {router: favoriteRouter} = require('./favorite');
const {router: commentRouter} = require('./comment');
const {router: followRouter} = require('./follow');
const {router: tagRouter} = require('./tag');
const {
  handleBoomError,
  handleCheckitError,
  handleError,
